...
const CloudDesktops = () => {
  usePageMeta({
    ...
    description: "Secure, powerful desktops in the cloud (VDI) — Windows, Linux, or macOS. Perfect for developers, call centers, BPOs, designers, and remote teams. Instant access. Fully managed."
  });
