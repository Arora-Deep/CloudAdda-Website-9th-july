  ...
  const playbooks = {
    "zero-to-live-lab": {
      ...
      content: `
        ...
        <ul class="space-y-4 mb-8">
          <li class="flex items-start space-x-3"><div class="w-2 h-2 bg-blue-500 rounded-full mt-3 flex-shrink-0"></div><div><strong class="text-gray-900">List tools and OS needed:</strong><span class="text-gray-700"> Ubuntu, Windows, macOS?</span></div></li>
          ...
          <li class="flex items-start space-x-3"><div class="w-2 h-2 bg-blue-500 rounded-full mt-3 flex-shrink-0"></div><div><strong class="text-gray-900">Include pre-installed packages:</strong><span class="text-gray-700"> e.g. VS Code, Anaconda, Wireshark, MySQL</span></div></li>
          <li class="flex items-start space-x-3"><div class="w-2 h-2 bg-blue-500 rounded-full mt-3 flex-shrink-0"></div><div><strong class="text-gray-900">Specify network configs, storage, and internet access</strong></div></li>
        </ul>

        <div class="bg-blue-50 border-l-4 border-blue-500 p-6 my-8 rounded-r-lg">
          <p class="text-blue-900 font-medium text-lg"><strong>Why it matters:</strong> A clear scope = zero back-and-forth during provisioning.</p>
        </div>

        <h2 id="heading-2" class="text-3xl font-bold text-gray-900 mt-16 mb-8">⚙️ Step 2: Send It to CloudAdda (Time: 5 min)</h2>
        <ul class="space-y-4 mb-8">
          <li class="flex items-start space-x-3"><div class="w-2 h-2 bg-orange-500 rounded-full mt-3 flex-shrink-0"></div><span class="text-gray-700">Email or submit the lab scope via the Lab Request Form</span></li>
          <li class="flex items-start space-x-3"><div class="w-2 h-2 bg-orange-500 rounded-full mt-3 flex-shrink-0"></div><span class="text-gray-700">Hop on a quick call (15–20 min) with a CloudAdda infra expert</span></li>
        </ul>

        <div class="bg-orange-50 border-l-4 border-orange-500 p-6 my-8 rounded-r-lg">
          <p class="text-orange-900 font-medium text-lg"><strong>Why it matters:</strong> CloudAdda doesn't give you a panel — it gives you people. Real engineers who read your plan and build the lab for you.</p>
        </div>
        ...
        <div class="bg-gray-50 p-6 rounded-xl mb-8">
          <ul class="space-y-3">
            <li class="flex items-start space-x-3"><div class="w-2 h-2 bg-green-500 rounded-full mt-3 flex-shrink-0"></div><span class="text-gray-700">Your environment is built on high-performance infra (NVMe, AMD EPYC)</span></li>
            <li class="flex items-start space-x-3"><div class="w-2 h-2 bg-green-500 rounded-full mt-3 flex-shrink-0"></div><span class="text-gray-700">Custom configs, toolchains, and scaling are set up</span></li>
            <li class="flex items-start space-x-3"><div class="w-2 h-2 bg-green-500 rounded-full mt-3 flex-shrink-0"></div><span class="text-gray-700">The lab is tested for stability under load</span></li>
          </ul>
        </div>
        ...
        <ul class="space-y-4 mb-8">
          ...
          <li class="flex items-start space-x-3"><div class="w-2 h-2 bg-cyan-500 rounded-full mt-3 flex-shrink-0"></div><span class="text-gray-700">Verify software, networking, file access, and control settings</span></li>
          <li class="flex items-start space-x-3"><div class="w-2 h-2 bg-cyan-500 rounded-full mt-3 flex-shrink-0"></div><span class="text-gray-700">Add optional branding or tracking (if needed)</span></li>
        </ul>

        <h2 id="heading-8" class="text-3xl font-bold text-gray-900 mt-16 mb-8">🎉 You're Live. You're in Control.</h2>
        ...
        <div class="overflow-x-auto mb-8">
          <table class="min-w-full bg-white border border-gray-200 rounded-lg shadow-sm">
            ...
            <tbody class="divide-y divide-gray-200">
              <tr><td class="px-6 py-4 text-sm font-medium text-gray-900">Plan</td><td class="px-6 py-4 text-sm text-gray-700">Define your exact lab needs</td><td class="px-6 py-4 text-sm text-gray-700">30 min</td></tr>
              <tr><td class="px-6 py-4 text-sm font-medium text-gray-900">Submit</td><td class="px-6 py-4 text-sm text-gray-700">Share with CloudAdda & discuss live</td><td class="px-6 py-4 text-sm text-gray-700">30 min</td></tr>
              <tr><td class="px-6 py-4 text-sm font-medium text-gray-900">Provision</td><td class="px-6 py-4 text-sm text-gray-700">CloudAdda builds and tests the lab</td><td class="px-6 py-4 text-sm text-gray-700">1.5 hr</td></tr>
              <tr><td class="px-6 py-4 text-sm font-medium text-gray-900">Final Review</td><td class="px-6 py-4 text-sm text-gray-700">You test and go live</td><td class="px-6 py-4 text-sm text-gray-700">1 hr</td></tr>
              <tr class="bg-orange-50"><td class="px-6 py-4 text-sm font-bold text-orange-900">Total Time</td><td class="px-6 py-4 text-sm text-gray-700"></td><td class="px-6 py-4 text-sm font-bold text-orange-900">~3 hrs</td></tr>
            </tbody>
          </table>
        </div>
      `
    ...
    "scaling-1000-students": {
      ...
      content: `
        ...
        <p class="text-lg leading-relaxed text-gray-700 mb-6">Pre-allocating resources? Manually provisioning instances? It works—until it doesn't.</p>

        <h3 id="heading-3" class="text-2xl font-semibold text-gray-900 mt-10 mb-6">3. Shared Resources = Sudden Failures</h3>
        <p class="text-lg leading-relaxed text-gray-700 mb-6">Cheap VPS or shared infra might look fine on paper, but under load, they buckle.</p>

        <h2 id="heading-4" class="text-3xl font-bold text-gray-900 mt-16 mb-8">The CloudAdda Scaling Philosophy</h2>

        <div class="grid md:grid-cols-2 gap-6 my-8">
          <div class="bg-blue-50 p-6 rounded-xl"><h4 class="font-semibold text-blue-900 mb-3">✅ Auto-Scaling on Demand</h4><p class="text-blue-800">We monitor student login patterns and pre-provision environments dynamically.</p></div>
          <div class="bg-green-50 p-6 rounded-xl"><h4 class="font-semibold text-green-900 mb-3">✅ Workload Isolation</h4><p class="text-green-800">Every lab runs in isolated containers or VMs—no shared memory, no shared CPU.</p></div>
          <div class="bg-purple-50 p-6 rounded-xl"><h4 class="font-semibold text-purple-900 mb-3">✅ Real-Time Monitoring</h4><p class="text-purple-800">Our ops team monitors CPU, memory, and IOPS per session in real-time.</p></div>
          <div class="bg-orange-50 p-6 rounded-xl"><h4 class="font-semibold text-orange-900 mb-3">✅ Purpose-Built Infra</h4><p class="text-orange-800">Our servers are optimized for bursty training workloads.</p></div>
        </div>
        ...
        <p class="text-lg leading-relaxed text-gray-700 mb-6">Pre-deploy different sets of labs across nodes. Students connect to available pools instantly.</p>
        ...
        <p class="text-lg leading-relaxed text-gray-700 mb-6">Set alerts on CPU/memory thresholds per lab. If thresholds cross 80%, auto-deploy backups.</p>

        <h2 id="heading-9" class="text-3xl font-bold text-gray-900 mt-16 mb-8">Final Thoughts</h2>
        <p class="text-lg leading-relaxed text-gray-700 mb-8">The quality of your training shouldn't be judged by your cloud provider's limits. With the right infra strategy, you scale effortlessly.</p>
      `
    },
    "virtual-lab-checklist": {
      ...
      content: `
        <div class="prose-intro">
          ...
          <p class="text-lg leading-relaxed text-gray-700 mb-8">Most virtual training failures don't happen during the session — they happen before it even starts. This checklist saves you from those moments.</p>
        </div>

        <h2 id="heading-0" class="text-3xl font-bold text-gray-900 mt-12 mb-6">✅ 1. Does Your Infra Match Your Curriculum?</h2>
        <p class="text-lg leading-relaxed text-gray-700 mb-6">If you're teaching Kubernetes, but your VMs have no Docker pre-installed... you're starting late and losing credibility.</p>
