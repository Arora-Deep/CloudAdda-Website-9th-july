    ...
    "zero-to-live-3-hours": {
      ...
      content: `
        ...
        <div class="bg-blue-50 border-l-4 border-blue-500 p-6 my-8 rounded-r-lg">
          <p class="text-blue-900"><strong>Why it matters:</strong> A clear scope = zero back-and-forth during provisioning. Good infra starts with great documentation.</p>
          <p class="text-blue-800 mt-2"><strong>Pro tip:</strong> Use our downloadable [Lab Planning Worksheet] to speed this up.</p>
        </div>

        <h2 id="heading-1" class="text-3xl font-bold text-gray-900 mt-16 mb-8">⚙️ Step 2: Send It to CloudAdda (Time: 5 min)</h2>
        ...
        <div class="bg-orange-50 border-l-4 border-orange-500 p-6 my-8 rounded-r-lg">
          <p class="text-orange-900"><strong>Why it matters:</strong> CloudAdda doesn't give you a panel — it gives you people. Real engineers who read your plan, understand your session goals, and build the lab for you.</p>
        </div>

        <h2 id="heading-2" class="text-3xl font-bold text-gray-900 mt-16 mb-8">🚀 Step 3: Sit Back While It's Provisioned (Time: 1.5 hr)</h2>
        ...
        <div class="bg-green-50 border-l-4 border-green-500 p-6 my-8 rounded-r-lg">
          <p class="text-green-900"><strong>Why it matters:</strong> Most DIY labs crash under real-world usage. Ours are purpose-built for 10 to 1,000 concurrent users. No surprises mid-session.</p>
        </div>

        <h2 id="heading-3" class="text-3xl font-bold text-gray-900 mt-16 mb-8">👩‍🏫 Step 4: Final Review & Go Live (Time: 1 hr)</h2>
        ...
        <div class="bg-purple-50 border-l-4 border-purple-500 p-6 my-8 rounded-r-lg">
          <p class="text-purple-900"><strong>Why it matters:</strong> The final sanity check before you hit the classroom. CloudAdda helps ensure everything is polished and production-grade.</p>
        </div>

        <h2 id="heading-4" class="text-3xl font-bold text-gray-900 mt-16 mb-8">🎉 You're Live. You're in Control. You're Not Alone.</h2>
        ...
        <h3 class="text-2xl font-semibold text-gray-900 mt-10 mb-6">Bonus Tools:</h3>
        ...
        <h2 id="heading-5" class="text-3xl font-bold text-gray-900 mt-16 mb-8">TL;DR — From Idea to Infra in 3 Hours</h2>
          ...
          <table class="w-full border-collapse border border-gray-300">
            ...
            <tbody>
              ...
              <tr class="bg-gray-50 font-semibold">
                ...
                <td class="border border-gray-300 px-4 py-2">~3 hrs</td>
              </tr>
            </tbody>
          </table>
        </div>
        ...
        <div class="bg-gradient-to-r from-blue-600 to-purple-600 text-white p-8 rounded-2xl my-12">
          <p class="text-lg leading-relaxed text-blue-100">Want help planning your next lab? 👉 [Schedule a free consultation with our training lab engineers]</p>
        </div>
      `
    },
    "scaling-1000-students": {
      title: "Scaling to 1,000 Students: Infrastructure Strategies That Don't Break Mid-Session",
      description: "The Dream: A Smooth, Scalable Training Experience",
      category: "Scaling",
      readTime: "15 min read",
      date: "Jan 20, 2025",
      author: "Sarah Chen",
      authorBio: "Infrastructure Scaling Expert with 12+ years experience",
      heroImage: "/lovable-uploads/2c2c88a8-7220-4594-bca2-cc4e5f6d6780.png",
      contentImage: "/lovable-uploads/1fc1b438-cdbd-423b-a581-fed76e12ae99.png",
      views: "2.1k",
      downloads: "456",
      content: `
        ...
        <h3 class="text-2xl font-semibold text-gray-900 mt-10 mb-6">1. Using Generic Cloud Platforms</h3>
        ...
        <h3 class="text-2xl font-semibold text-gray-900 mt-10 mb-6">2. Manual Scaling Is a Time Bomb</h3>
        ...
        <h3 class="text-2xl font-semibold text-gray-900 mt-10 mb-6">3. Shared Resources = Sudden Failures</h3>
        ...
        <h2 id="heading-1" class="text-3xl font-bold text-gray-900 mt-16 mb-8">The CloudAdda Scaling Philosophy</h2>
        <p class="text-lg leading-relaxed text-gray-700 mb-6">At CloudAdda, we've provisioned thousands of labs for training firms scaling from 10 to 10,000 users. Here's what works:</p>
        ...
        <div class="space-y-6 mb-8">
          <div class="bg-green-50 p-6 rounded-xl">
            ...
            <p class="text-green-800">We monitor student login patterns and pre-provision environments dynamically. No cold starts. No crashes.</p>
          </div>
          ...
          <div class="bg-blue-50 p-6 rounded-xl">
            ...
            <p class="text-blue-800">Every lab runs in isolated containers or VMs—no shared memory, no shared CPU. If one crashes, it doesn't bring down others.</p>
          </div>
        ...
        <h2 id="heading-2" class="text-3xl font-bold text-gray-900 mt-16 mb-8">Scaling Strategies You Can Steal Today</h2>
        
        <h3 class="text-2xl font-semibold text-gray-900 mt-10 mb-6">1. Use Parallel Lab Pools</h3>
        ...
        <h3 class="text-2xl font-semibold text-gray-900 mt-10 mb-6">2. Time-Zone Based Scaling Windows</h3>
        ...
        <h3 class="text-2xl font-semibold text-gray-900 mt-10 mb-6">3. Integrate Smart Alerts</h3>
        ...
        <h2 id="heading-3" class="text-3xl font-bold text-gray-900 mt-16 mb-8">Final Thoughts: Don't Let Infra Be the Weakest Link</h2>
        <p class="text-lg leading-relaxed text-gray-700 mb-6">The quality of your training shouldn't be judged by your cloud provider's limits. With the right infra strategy, you scale effortlessly—and look like a pro while doing it.</p>

        <div class="bg-gradient-to-r from-blue-600 to-purple-600 text-white p-8 rounded-2xl my-12">
          <p class="text-lg leading-relaxed text-blue-100 mb-4">👉 Need help planning a 1,000-student session? [Get a Custom Scaling Plan]</p>
          <p class="text-lg leading-relaxed text-blue-100">👉 Want the checklist we use internally? [Download Our Lab Scaling Checklist]</p>
        </div>

        <p class="text-lg leading-relaxed text-gray-700 mt-8"><strong>About CloudAdda:</strong> We power high-performance, crash-proof training labs for leading training companies all around the world. Same-day provisioning. Zero headaches.</p>
      `
    },
    "virtual-lab-checklist": {
      title: "The Ultimate Virtual Lab Checklist: Don't Miss These 7 Things Before You Go Live",
      description: "Going Live Without a Plan? That's a Disaster Waiting to Happen.",
      category: "Quality Assurance",
      readTime: "10 min read",
      date: "Jan 18, 2025",
      author: "Mike Johnson",
      authorBio: "Quality Assurance Expert with 8+ years in virtual training",
      heroImage: "/lovable-uploads/2c2c88a8-7220-4594-bca2-cc4e5f6d6780.png",
      contentImage: "/lovable-uploads/1fc1b438-cdbd-423b-a581-fed76e12ae99.png",
      views: "1.5k",
      downloads: "289",
      content: `
        <div class="prose-intro">
          <p class="text-xl leading-relaxed text-gray-700 mb-8">Most virtual training failures don't happen during the session — they happen before it even starts. Because the lab wasn't fully tested. Because the infra wasn't ready. Because someone missed something obvious.</p>
        </div>
        ...
        <div class="bg-blue-50 border-l-4 border-blue-500 p-6 my-8 rounded-r-lg">
          <p class="text-blue-900"><strong>CloudAdda Tip:</strong> We pre-map your curriculum to infra templates. So nothing gets missed.</p>
        </div>
        ...
        <div class="bg-green-50 border-l-4 border-green-500 p-6 my-8 rounded-r-lg">
          <p class="text-green-900"><strong>CloudAdda Tip:</strong> Our environments scale automatically and are pre-load tested for 1,000+ concurrent users.</p>
        </div>
        ...
        <div class="bg-orange-50 border-l-4 border-orange-500 p-6 my-8 rounded-r-lg">
          <p class="text-orange-900"><strong>CloudAdda Tip:</strong> We auto-generate and bulk-send credentials, with built-in SSO support.</p>
        </div>
        ...
        <div class="bg-purple-50 border-l-4 border-purple-500 p-6 my-8 rounded-r-lg">
          <p class="text-purple-900"><strong>CloudAdda Tip:</strong> 24/7 support by engineers. 47 min avg response.</p>
        </div>
        ...
        <div class="bg-red-50 border-l-4 border-red-500 p-6 my-8 rounded-r-lg">
          <p class="text-red-900"><strong>CloudAdda Tip:</strong> Auto-failover is built in. And backups run daily.</p>
        </div>
        ...
        <div class="bg-cyan-50 border-l-4 border-cyan-500 p-6 my-8 rounded-r-lg">
          <p class="text-cyan-900"><strong>CloudAdda Tip:</strong> Trainer dashboards show live usage, progress, and system status.</p>
        </div>
        ...
        <ul class="space-y-4 mb-8">
          <li class="flex items-start space-x-3">
            <div class="w-2 h-2 bg-indigo-500 rounded-full mt-3 flex-shrink-0"></div>
        ...
        <div class="bg-indigo-50 border-l-4 border-indigo-500 p-6 my-8 rounded-r-lg">
          <p class="text-indigo-900"><strong>CloudAdda Tip:</strong> We always include a free test deployment before launch day.</p>
        </div>

        <h2 id="heading-7" class="text-3xl font-bold text-gray-900 mt-16 mb-8">Ready to Launch With Confidence?</h2>
        <p class="text-lg leading-relaxed text-gray-700 mb-6">CloudAdda builds and tests every training lab against this checklist — and 30+ more internal criteria.</p>
        
        <div class="bg-gray-50 p-6 rounded-xl mb-8">
          <ul class="space-y-3">
            <li class="flex items-start space-x-3">
              <CheckCircle className="w-5 h-5 text-green-500 mt-0.5 flex-shrink-0" />
              <span class="text-gray-700">✅ You send your curriculum.</span>
            </li>
            <li class="flex items-start space-x-3">
              <CheckCircle className="w-5 h-5 text-green-500 mt-0.5 flex-shrink-0" />
              <span class="text-gray-700">✅ We send back a ready-to-run lab.</span>
            </li>
          </ul>
        </div>

        <div class="bg-gradient-to-r from-blue-600 to-purple-600 text-white p-8 rounded-2xl my-12">
          <p class="text-lg leading-relaxed text-blue-100">Schedule Your Custom Lab Deployment Today →</p>
        </div>
      `
    }
  };

  const playbook = playbooks[id as keyof typeof playbooks] || playbooks["zero-to-live-3-hours"];
