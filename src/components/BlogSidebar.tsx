    ...
    <div className="space-y-6 sticky top-24">
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-5">
        ...
        <div className="space-y-2">
          <a href="https://www.linkedin.com/company/cloudadda" target="_blank" rel="noopener noreferrer"
          ...
          <a href="https://x.com/cloudadda" target="_blank" rel="noopener noreferrer"
            ...
            <span className="text-sm text-gray-700 group-hover:text-gray-900 font-medium">X (Twitter)</span>
          </a>
          <a href="https://www.instagram.com/cloudadda" target="_blank" rel="noopener noreferrer"
            className="flex items-center gap-3 px-3 py-2.5 rounded-lg hover:bg-pink-50 transition-colors group">
            ...
            <span className="text-sm text-gray-700 group-hover:text-pink-600 font-medium">Instagram</span>
          </a>
          <a href="https://wa.me/919876543210" target="_blank" rel="noopener noreferrer"
            ...
            <span className="text-sm text-gray-700 group-hover:text-green-600 font-medium">WhatsApp</span>
          </a>
        </div>
      </div>
      ...
      <div className="bg-gradient-to-br from-orange-500 to-orange-600 rounded-xl p-5 text-white">
        ...
        <p className="text-sm text-orange-100 mb-4">
          Set up your cloud training lab in under 3 hours with CloudAdda.
        </p>
        <Link to="/contact">
          <Button className="w-full bg-white text-orange-600 hover:bg-gray-100 rounded-full text-sm font-semibold">
            Talk to Us
